<template>
  <v-app>
    ...
    <template v-else>
      ...
      <v-main v-show="hydrated && !pageLoading">
...
const breadcrumbs = computed(() => {
  ...
  if (metaCrumbs?.length) return metaCrumbs;

  const title = ((route.meta as any)?.title as string) || "Admin";
  return [
    { title: "Admin", disabled: false, to: "/" },
    { title, disabled: true },
  ];
});
